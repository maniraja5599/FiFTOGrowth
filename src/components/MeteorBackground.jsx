    ...
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
            ...
            {[...Array(20)].map((_, idx) => {
                ...
                const shadowColor = isRed ? 'shadow-[0_0_5px_rgba(239,68,68,0.5)]' : 'shadow-[0_0_5px_rgba(34,197,94,0.5)]';
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-premium-gold/5 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s', animationDelay: '1s' }} />
            </div>
        </div>
    );
};
